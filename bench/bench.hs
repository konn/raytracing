...
mkMetalSpheres :: Int -> StdGen -> Antialiasing -> WordImage
...
mkCornellBox :: CornellMode -> Int -> StdGen -> Antialiasing -> WordImage
{-# INLINE mkCornellBox #-}
...
mkImage :: Scene -> Int -> StdGen -> Antialiasing -> WordImage
